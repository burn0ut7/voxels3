...
internal static class SurfaceWater
{
	...
	public static WorldMedium Resolve( float z, float surfaceHeight, float solidDensity, float seaLevel )
	{
		if ( solidDensity <= 0f ) return WorldMedium.Solid;
		return surfaceHeight < z && z < seaLevel ? WorldMedium.Water : WorldMedium.Air;
	}
}
