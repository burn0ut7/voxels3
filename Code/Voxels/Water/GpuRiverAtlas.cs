...
internal sealed class GpuRiverAtlas : IDisposable
{
	...
	public static Vector4 Rules => new( RiverNetwork.NodeSpacing, 0f,
	...
	public static Data Pack( RiverWorld.Region region, CancellationToken cancellation = default )
	{
		...
		{
			// Water elevation is uniform; use Z to transport precomputed bed depth.
			texels[cursor++] = new Vector4( segment.Start.x, segment.Start.y, segment.StartDepth, segment.StartRadius );
			texels[cursor++] = new Vector4( segment.End.x, segment.End.y, segment.EndDepth, segment.EndRadius );
		}
