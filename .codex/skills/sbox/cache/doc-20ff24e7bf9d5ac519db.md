...
[Components](/dev/doc/scene/components) can contain RPCs. An RPC is a function that when called, is called remotely too.


Supported RPC arguments are the exact same as [Sync properties.](/dev/doc/networking/sync-properties) 
