...
internal sealed partial class GpuVoxelMesher : IDisposable
{
	...
	private sealed class GeometryArena : IDisposable
	{
		...
		public GpuBuffer<Vector4> DepthRanges { get; } = new( RegionsPerSlab, GpuBuffer.UsageFlags.Structured, "Voxel Depth Triangle Ranges" );
		...
		public void Dispose() { Vertices.Dispose(); Indices.Dispose(); DepthRanges.Dispose(); DepthArguments.Dispose(); }
	}
