...
User requested complete terrain parallax removal. The shared shader now samples
undisplaced stochastic UVs for all five surfaces. Height ray marching and relief
parameters are removed; color, normal, roughness, occlusion, triplanar blending
and 16x filtering remain. Packed height data remains unused. This supersedes
the earlier parallax candidates and surface-tangent correction.
