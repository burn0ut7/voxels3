...
| How should forests, grasslands, hills and mountains be generated? | [Biome terrain generation](Research/BiomeTerrainGeneration.md): primary-source comparisons, landform and temperature/moisture controls, compatible biome transitions, bounded population and future feature boundaries; research only. |
