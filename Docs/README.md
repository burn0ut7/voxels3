...
| How should forests, grasslands, hills and mountains be generated? | [Biome terrain generation](Research/BiomeTerrainGeneration.md): primary-source comparisons, proposed landform/cover recipe, bounded population, frame-pacing priorities and future feature boundaries; research only. |
