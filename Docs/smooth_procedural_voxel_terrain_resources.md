...
| Biomes, coherent landforms, runtime population and future regional features | [Biome terrain proposal](Research/BiomeTerrainGeneration.md), [biome sources below](#biome-generation-and-regional-features) | Separates shipped-game evidence from the eight-biome climate/terrain proposal and its acceptance limits. |
...
| Making nearby LOD0 feel immediate | [LOD arrival comparison and prototype ranking](Research/ChunkPerformanceOptimizationFindings.md#lod-arrival-research---2026-09-13), [legacy predictive invoker](https://docs.voxelplugin.com/1.2/core-systems/voxelworld/world-size-and-level-of-details) | Separates preparation from arrival, corrects one-second observation limits, and ranks current-source experiments; no matched cross-game speed claim. |
...
[Tree generation research](Research/TreeGeneration.md) owns geometry/reuse and
visual-production proposals. [Spawn trees](Architecture/SpawnTrees.md) owns the
current prototype, whose visuals were rejected and performance is unqualified.
...
| [Niinemets and Lukjanova (2003)](https://nph.onlinelibrary.wiley.com/doi/10.1046/j.1469-8137.2003.00712.x) | Annual needle cohorts, terminal whorls and internodal branches inform spruce crown architecture. | Observed retention and branching depend on environment; do not transfer a single branch ratio to every order or species. |
| [Klein et al. (2016)](https://besjournals.onlinelibrary.wiley.com/doi/10.1111/1365-2745.12621) | Six to eight years of needle retention at the study site inform the candidate six-cohort authoring profile. | Sampled sunlit branches of mature spruce; model seasons are not calibrated biological years and this does not qualify every tree age or site. |
| [Fedorchak et al. (2024), Table 2](https://sciendo.com/2/v2/download/article/10.2478/eko-2024-0015.pdf) | Reported 144.6 needles per 7.25 cm second-order shoot gives approximately 1994 needles/m; candidate reference density is 2000/m. | Site-specific two-year shoots in pollution-gradient plantations. The indexed primary table supports these values; a universal needle-density or crown-coverage claim does not follow. |
| [Self-organizing tree models for image synthesis (Palubicki et al., 2009)](https://algorithmicbotany.org/papers/selforg.sig2009.html) | Shared bud/light/allocation responsibilities; section4.2 confirms bud-light-derived root signal and discusses removal of apical control with age. See [growth model](Architecture/TreeGrowth.md). | Our BH-style allocation and016continuous age relaxation adapt those ideas. The paper illustrates age changes with its priority model; our twelve-season oak setting is uncalibrated. No transfer of its biology, collision guarantees or visual/performance results. |
| [Oak shoot lengths and bud numbers (Buck-Sorlin and Bell, 2000)](https://doi.org/10.1093/forestry/73.1.1) | Multiple bud sites per annual shoot and distinguishing distal from median buds in the shared growth model. | Measured Q.robur/Q.petraea architecture supports those responsibilities, not our chosen internode spacing, bud-priority exponents or density controls. |
| [Parametrization of tree branching architectures (Nauber et al., 2024)](https://doi.org/10.1093/treephys/tpae045) | Separate bud priority, supporting wood and tropic response within a common species-driven model. | Our implementation does not reproduce its physiology, fitted parameters or reported shape validation; local visual and age checks remain necessary. |
| [UF/IFAS: developing root flare](https://hort.ifas.ufl.edu/woody/root-growth-developing-flare.shtml), [UF/IFAS: roots, out of sight](https://blogs.ifas.ufl.edu/duvalco/2021/11/30/roots-out-of-sight-out-of-mind/) | Qualitative distinction between a swollen trunk base and shallow structural roots for the derived root geometry. | No fitted dimensions, species calibration or soil simulation are adopted. Linked photographs could not be retrieved; this is textual guidance, not a photo-based validation. |
| [Modular Tree 5.5.2](https://github.com/GoodPie/modular_tree/tree/eca242d1b7208ea2b0834a1d8723f5732c43dd2a) | Offline branch generation, connected wood meshing, leaf geometry and attachment data; [project feasibility assessment](Research/ModularTreeEvaluation.md). | Native module works in Blender 5.2.2; visual improvement and s&box integration remain unverified. Growth uses simplified vigor; exported hierarchy depth is not a parent ID. Blender billboarding/leaf LODs do not export as live engine behavior. MIT core and GPL addon are distinct. |
| [Woodland Trust: English oak](https://www.woodlandtrust.org.uk/trees-woods-and-wildlife/british-trees/a-z-of-british-trees/english-oak/), [Glen Eira assessed oak](https://www.gleneira.vic.gov.au/our-city/classified-trees/classified-tree-register/184ctr2021-springthorpe-gardens) | Real stature, age-related form and a measured crown wider than the tree's height. | Botanical/art direction references, not a growth algorithm; the council example is one specimen, not a universal proportion. |
...
| [Guerrilla: vegetation of Horizon Zero Dawn](https://media.gdcvault.com/gdc2018/presentations/gilbert_sanders_between_tech_and.pdf) | Component baking, tree LODs and separate shadow representations. | GDC 2018 pipeline; triangle counts and proprietary rendering do not establish s&box budgets. |
| [DICE: Photogrammetry and Star Wars Battlefront](https://media.gdcvault.com/gdc2016/Presentations/Brown_Kenneth_Hamilton_Andrew_PhotogrammetryStarWars.pdf) | Foliage normal construction and scanned-base/tiling-bark workflow. | GDC 2016 production; no claim that an entire forest should be scanned or that source art is reusable without permission. |
| [Guerrilla: deferred texturing in Horizon Forbidden West](https://www.guerrilla-games.com/read/adventures-with-deferred-texturing-in-horizon-forbidden-west) | Foliage shading cost and alpha-tested geometry in a shipped game. | Overview-level renderer evidence; no inferred leaf-mesh budgets or portable engine integration. |
| [Remedy: GPU skinning for vegetation in Alan Wake 2](https://presentations.remedy.fi/large-scale-gpu-based-skinning-for-vegetation-in-alan.ppsx) | Reuse of large-tree animation work, early skeletal-LOD difficulties and animation bounds. | Slide XML inspected, embedded videos not reviewed; Northlight integration and its variant terminology do not establish s&box capabilities or a perceptual library size. |
| [Epic: Nanite in Fortnite Chapter 4](https://www.unrealengine.com/tech-blog/bringing-nanite-to-fortnite-battle-royale-in-chapter-4), [shadow rendering](https://www.unrealengine.com/tech-blog/virtual-shadow-maps-in-fortnite-battle-royale-chapter-4) | Geometry-versus-alpha tradeoffs, coverage preservation, wind and shadow proxies. | Content- and renderer-specific results; do not copy vertex counts as conventional mesh budgets. |
| [Epic: Impostor Baker](https://dev.epicgames.com/documentation/en-us/unreal-engine/impostor-baker-plugin-in-unreal-engine) | Matched multi-view distant tree representations. | Plugin and shader are Unreal-specific; memory, pixel work and transition quality still require measurement. |
| [Epic: Nanite Foliage](https://dev.epicgames.com/documentation/unreal-engine/nanite-foliage) | Reusable assemblies, aggregate distant detail and skeletal wind as frontier research. | Experimental in retrieved documentation; Witcher 4 technical demo, not shipped-game evidence or an s&box feature. |
| [Crytek: Crysis vegetation](https://developer.nvidia.com/gpugems/gpugems3/part-iii-rendering/chapter-16-vegetation-procedural-animation-and-shading-crysis), [NVIDIA: SpeedTree rendering](https://developer.nvidia.com/gpugems/gpugems3/part-i-geometry/chapter-4-next-generation-speedtree-rendering) | Leaf shading, material data, motion and silhouette-versus-surface detail. | Historical techniques/demonstration extensions, not current default middleware behavior or performance. |
...
| [Epic: World Partition HLOD](https://dev.epicgames.com/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine) | Separate cell residency from distant visibility; instance foliage impostors or use regional proxies. See the [large-world tree study](Research/LeafRenderingOptimization.md#large-world-scaling-follow-up). | Unreal-specific tooling; procedural edits require explicit proxy invalidation, and s&box residency/batching costs still need measurement. |
...
| [Mojang: experimental world-generation notes](https://www.minecraft.net/en-us/article/new-world-generation-java-available-testing), [Kniberg: terrain generation overview](https://www.youtube.com/watch?v=CSa5O6knuwI) | Developer references for large-region variety, mountain/flatland balance and the staged terrain/cave/biome explanation. | Notes are historical iteration evidence. Video description/chapter list only was accessible in this review; exact backend/spline claims require additional evidence. |
| [Wube: New terrain, new planet](https://www.factorio.com/blog/post/fff-401) | Separate amount/scale controls, combined elevation contributions and traversal-focused evaluation. | 2D terrain/cliffs and author-reported outcomes do not prove volumetric topology, connected continents or s&box timing. |
| [AutoBiomes: Fischer et al., 2020](https://cgvr.cs.uni-bremen.de/papers/cgi20/AutoBiomes.pdf) | Explicit rough terrain, climate, biome refinement and population sequence supports a staged hybrid while retaining the existing base height. | Finite offline grids and DEM refinement; not streamed SDF performance evidence. PDF text and pipeline figure inspected in the September20 study. |
| [Luanti biome definitions](https://api.luanti.org/definition-tables/#biome-definition), [biome generator source](https://github.com/luanti-org/luanti/blob/master/src/mapgen/mg_biome.cpp) | Inspectable heat/humidity-space classification with altitude constraints. | Climate-space nearest-center selection alone does not guarantee minimum geographic transition width; moving source snapshot, not a pinned game release. |
| [libnoise: Creating more complex terrain](https://libnoise.sourceforge.net/tutorials/tutorial5.html) | Inspectable separation of terrain-type controls from flat/mountain profiles and smooth selection falloff. | Historical C++ tutorial, not a modern performance comparison; do not adopt its graph framework or full-map generation as the Voxels3 architecture. |
...
| [Voxel Plugin 1.2 predictive invoker](https://docs.voxelplugin.com/1.2/core-systems/voxelworld/world-size-and-level-of-details) | Explicit preparation ahead of fast-moving characters. | Designing bounded directional lead in the existing streamer. | Historical Unreal feature; no measured Voxels3 benefit or claim that current Voxel Plugin 2 uses the same policy. |
| [Voxel Tools clipbox handoff, pinned](https://github.com/Zylann/godot_voxel/blob/0869fdc925bf6e270892e09ac3803a399d21d11e/terrain/variable_lod/voxel_lod_terrain_update_clipbox_streaming.cpp#L1449) | Local sibling activation, concurrent LOD loading, and documented dropped-task hazards. | Comparing exact request lifetime and coherent parent replacement. | Godot-specific implementation with unresolved comments; not an independently benchmarked best-in-class system. |
...
| [Voxel Tools streams](https://voxel-tools.readthedocs.io/en/latest/streams/), [multiplayer](https://voxel-tools.readthedocs.io/en/latest/multiplayer/) | Saving expensive generated blocks, asynchronous world lifetime, server-owned viewers and the dated client-generated baseline/server-edited-data approach. | Multiplayer page is experimental and does not establish VoxelLodTerrain support or arbitrary generation-mismatch deltas. |
| [Space Engineers procedural asteroids](https://github.com/KeenSoftwareHouse/SpaceEngineers/blob/54f2f0f3169cda687a25a438097902a43bdfa603/Sources/Sandbox.Game/Game/World/Generator/MyProceduralAsteroidCellGenerator.cs), [voxel operations](https://github.com/KeenSoftwareHouse/SpaceEngineers/blob/54f2f0f3169cda687a25a438097902a43bdfa603/Sources/Sandbox.Game/Game/MyVoxelBase.cs) | Historical game-source evidence for seeded procedural content, saving changed terrain and networked voxel operations. | Archived source; does not establish current shipped behavior, arbitrary client/server mismatch repair or Voxels3 security/performance. |
...
| [Dual Marching Cubes: Primal Contouring of Dual Grids](https://people.eecs.berkeley.edu/~jrs/meshpapers/SchaeferWarren.pdf) | Schaefer and Warren's 2005 adaptive dual-grid extraction paper. | Investigating sparse geometry and thin-feature representation if extraction becomes the measured arrival bottleneck. | Not identical to Dual Contouring; Hello Games' algorithm name does not prove use of this paper unchanged. GPU/edit/seam integration needs a separate design. |
...
| [HLSL precise variable semantics](https://learn.microsoft.com/en-us/windows/win32/direct3dhlsl/dx-graphics-hlsl-variable-syntax) | Operation-order and contraction controls when matching CPU/GPU procedural fields. | Source qualifiers are not proof of backend enforcement: CAVEPLAY-012/v3 compiled but preserved the mismatch; the inspected SPIR-V payload had no NoContraction decorations. Require generated-code and runtime evidence. |
| [Slang local precise SPIR-V issue](https://github.com/shader-slang/slang/issues/12198), [proposed fix](https://github.com/shader-slang/slang/pull/12208), [s&box compiler migration](https://sbox.game/news/update-26-08-05) | Explains a compiler failure mode matching the missing NoContraction decorations in CAVEPLAY-012/v3; distinguishes local qualifiers from global/function precision modes. | Upstream report and open fix do not identify the installed Slang revision or prove the cave mismatch root cause. Do not replace engine binaries or assume compiler API options are exposed to project shaders. |
| [Slang fma](https://docs.shader-slang.org/en/latest/external/core-module-reference/global-decls/fma.html), [Khronos GLSL.std.450 Fma](https://registry.khronos.org/SPIR-V/specs/unified1/GLSL.std.450.html) | Assess whether explicit fused arithmetic can stabilize simplex origin/rank selection. | Slang emits GLSL.std.450 Fma; without NoContraction its precision is not constrained to a fused operation. A CPU FusedMultiplyAdd match on one GPU is not portable parity proof. |
...
| Reference | Use in Voxels3 | Transfer limits |
| --- | --- | --- |
| [Mikkelsen: Surface Gradient-Based Bump Mapping Framework](https://jcgt.org/published/0009/03/04/paper-lowres.pdf) | Sections4.3-4.4 explain physical-scale parallax and triplanar surface-gradient composition. Sections3.7/4.6 motivate analytic virtual-surface footprints for fine detail where neighboring POM hits are discontinuous; the BO experiment uses a local-plane derivative derived from existing pixel rays. Section4.3 also motivates BR's derivative-aware chart mapping, with separate lookup coordinates and physical hits; face/smooth-normal mismatch and omitted curvature remain explicit transfer limits. | A shading formulation, not proof of our source-map calibration, virtual-side texture quality, engine support or performance; proposed adoption is tracked in the relief plan. |
...
| [Unity HDRP 17 displacement](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.0/manual/Displacement-Mode.html) | Physical height/tiling contracts, bounded sample settings, mip fading and optional depth offset; adoption choices are in [the terrain relief proposal](Plans/TerrainReliefImplementation.md). | Production comparison, not an s&box API or proof of terrain lighting/depth compatibility, silhouettes or measured performance. |
...
### Brown Mud03 material-source experiment (2026-09-19)

[Poly Haven Brown Mud03](https://polyhaven.com/a/brown_mud_03), Rob Tuytel,
[CC0](https://polyhaven.com/license): matching scan color, height, normal,
occlusion and roughness at documented1.3m width. BX adopts this source for
dirt art evaluation because its distinct clods and compact patches retain
color/height correspondence. The100mm height interval is our unaccepted art
choice, not measured source depth. Wet patches/footprints limit its suitability
for generic dry soil. Asset quality does not establish parallax correctness;
see the implementation plan and validation ledger.
